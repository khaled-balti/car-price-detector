  ...
  return (
    <div className='d-flex flex-column align-items-center'>
            ...
            <div className='container px-0'>
                    ...
                    <div className='row'>
                        <div className='col-6'>
                            <div onClick={() => {setLights(1)}} className={`col-12 d-flex align-items-center ${classes.cont} mb-3 ps-3`} style={{backgroundColor: lights === 1 && '#E7E9FF'}}>
                        ...
                        <div className='col-6'>
                            <div onClick={() => {setLights(2)}} className={`col-12 d-flex align-items-center ${classes.cont} mb-3 ps-3`} style={{backgroundColor: lights === 2 && '#E7E9FF'}}>
                ...
                <div className='container px-0'>
                    ...
                    <div className='row'>
                        <div className='col-6'>
                            <div onClick={() => {setSuspensions(1)}} className={`col-12 d-flex align-items-center ${classes.cont} mb-3 ps-3`} style={{backgroundColor: suspensions === 1 && '#E7E9FF'}}>
                        ...
                        <div className='col-6'>
                            <div onClick={() => {setSuspensions(2)}} className={`col-12 d-flex align-items-center ${classes.cont} mb-3 ps-3`} style={{backgroundColor: suspensions === 2 && '#E7E9FF'}}>
                ...
                <div className='container px-0'>
                    ...
                    <div className='row'>
                        <div className='col-6'>
                            <div onClick={() => {setBrakes(1)}} className={`col-12 d-flex align-items-center ${classes.cont} mb-3 ps-3`} style={{backgroundColor: brakes === 1 && '#E7E9FF'}}>
                        ...
                        <div className='col-6'>
                            <div onClick={() => {setBrakes(2)}} className={`col-12 d-flex align-items-center ${classes.cont} mb-3 ps-3`} style={{backgroundColor: brakes === 2 && '#E7E9FF'}}>
