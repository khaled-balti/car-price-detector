  ...
  return (
    <div className='d-flex flex-column align-items-center'>
      ...
      <div className='container d-flex flex-column justify-content-between align-items-center mt-4 pb-2' style={{paddingLeft: '60px', paddingRight: '60px'}}>
        <div onClick={() => {setModeChecked(1)}} className={`d-flex justify-content-evenly align-items-center ${classes.cont} mb-3`} style={{backgroundColor: modeChecked === 1 && '#E7E9FF'}}>
        ...
        <div onClick={() => {setModeChecked(2)}} className={`d-flex justify-content-evenly align-items-center ${classes.cont} mb-3`} style={{backgroundColor: modeChecked === 2 && '#E7E9FF'}}>
            <div className={`${classes.imgcont} d-flex justify-content-center bg-light align-items-center`}>
                <img src={Cube} alt='error' className={classes.cubeimg} />
            </div>
        ...
        <div onClick={() => {setModeChecked(3)}} className={`d-flex justify-content-evenly align-items-center ${classes.cont} mb-3`} style={{backgroundColor: modeChecked === 3 && '#E7E9FF'}}>
            <div className={`${classes.imgcont} d-flex justify-content-center bg-light align-items-center`}>
                <img src={Cube} alt='error' className={classes.cubeimg} />
            </div>
