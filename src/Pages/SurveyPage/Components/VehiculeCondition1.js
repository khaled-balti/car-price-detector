    ...
    <div className='d-flex flex-column align-items-center'>
            ...
            <div className='container-fluid px-5'>
                <div className='mb-3'>
                    ...
                    <select className={classes.select} onChange={handleGeneralCondition}>
                ...
                <div className='mb-3'>
                    ...
                    <select className={classes.select} onChange={handleOwnersNumber}>
                ...
                <div className='container px-0'>
                    ...
                    <div className='row'>
                        <div className='col-6'>
                            <div onClick={() => {setAccident(1); setInfos({...infos, isAccidented: false})}} className={`col-12 d-flex align-items-center ${classes.cont} mb-3 ps-3`} style={{backgroundColor: accident === 1 && '#E7E9FF'}}>
                                <input type='radio' name='fuel' checked={accident === 1} className={classes.radio} />
                                <p className={`me-3 ${classes.text}`}>No</p>
                            </div>
                        </div>
                        
                        <div className='col-6'>
                            <div onClick={() => {setAccident(2); setInfos({...infos, isAccidented: true})}} className={`col-12 d-flex align-items-center ${classes.cont} mb-3 ps-3`} style={{backgroundColor: accident === 2 && '#E7E9FF'}}>
                                <input type='radio' name='fuel' checked={accident === 2} className={classes.radio} />
