        ...
        <div className='container d-flex flex-column justify-content-between align-items-center mt-4 pb-2' style={{paddingLeft: '60px', paddingRight: '60px'}}>
            <div className='container'>
                ...
                <div className='row'>
                    ...
                    <div className='col-6'>
                        <div onClick={() => {setFuelChecked(4); setInfos({...infos, energie: "Hybride"})}} className={`col-12 d-flex align-items-center ${classes.cont} mb-3 ps-3`} style={{backgroundColor: fuelChecked === 4 && '#E7E9FF'}}>
            ...
            <div className='container'>
                ...
                <div className='row'>
                    <div className='col-6'>
                        <div onClick={() => {setGeaboxChecked(1); setInfos({...infos, boite: "Automatique"})}} className={`col-12 d-flex align-items-center ${classes.cont} mb-3 ps-3`} style={{backgroundColor: geaboxChecked === 1 && '#E7E9FF'}}>
                    ...
                    <div className='col-6'>
                        <div onClick={() => {setGeaboxChecked(2); setInfos({...infos, boite: "Manuelle"})}} className={`col-12 d-flex align-items-center ${classes.cont} mb-3 ps-3`} style={{backgroundColor: geaboxChecked === 2 && '#E7E9FF'}}>
