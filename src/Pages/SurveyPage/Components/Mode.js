...
const Mode = ({step, setStep, setInfos, infos}) => {
  ...
  return (
    <div className='d-flex flex-column align-items-center'>
      ...
      <div className='container d-flex justify-content-between align-items-center mt-4 pb-5' style={{paddingLeft: '60px', paddingRight: '60px'}}>
        <div onClick={() => {setModeChecked(1); setInfos({...infos, mode: "buyer"})}} className={`d-flex flex-column justify-content-evenly align-items-center ${classes.cont}`} style={{backgroundColor: modeChecked === 1 && '#E7E9FF'}}>
        ...
        <div onClick={() => {setModeChecked(2); setInfos({...infos, mode: "seller"})}} className={`d-flex flex-column justify-content-evenly align-items-center ${classes.cont}`} style={{backgroundColor: modeChecked === 2 && '#E7E9FF'}} >
